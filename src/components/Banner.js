    ...
    return (
        <BannerContainer>
            <center>
                ...
                <img className="img2" src="https://images.samsung.com/in/smartphones/galaxy-note10/images/galaxy-note10_highlights_perfomance_laptop.png" alt="banner2" />
...
*The actual text export function may require some processing to turn writing into text.</p>
                ...
                <button>LEARN MORE</button><br />
                <img className="img4" src="https://images.samsung.com/in/smartphones/galaxy-note10/images/galaxy-note10_highlights_acc_b_m.jpg" alt="banner4" />
            </center>
